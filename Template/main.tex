...
\justifying
\noindent
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam lacinia ultrices felis, et scelerisque velit bibendum vel.
In hac habitasse platea dictumst. Praesent sit amet leo et erat vulputate consequat non vitae risus. Curabitur varius, 
turpis ut varius vestibulum, nisi mi sollicitudin turpis, id ultricies velit lorem a est. Vestibulum auctor consequat 
libero, a euismod libero fringilla nec. Ut vel varius urna, vitae egestas ligula. Morbi ac nulla eu metus tincidunt 
suscipit. Curabitur sed lacus et orci interdum consequat et ut eros. Phasellus luctus leo at libero vestibulum, sed 
volutpat lectus dictum.
...
\input{3. Empirical Data}
\input{4. Descriptive Analysis}
\input{5. Empirical Methodology}
\input{6. Results}
\input{7. Further Analysis}
\input{8. Discussion}
